...
class OnboardingActivity : AppIntro2() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sliderPage1.backgroundColor = ContextCompat.getColor(this, R.color.turquoise_cloud_0)
        ...
        sliderPage2.backgroundColor = ContextCompat.getColor(this, R.color.turquoise_cloud_0)
        ...
        sliderPage3.backgroundColor = ContextCompat.getColor(this, R.color.turquoise_cloud_0)
        ...
        sliderPage4.backgroundColor = ContextCompat.getColor(this, R.color.turquoise_cloud_0)
        ...
        sliderPage5.backgroundColor = ContextCompat.getColor(this, R.color.turquoise_cloud_0)
